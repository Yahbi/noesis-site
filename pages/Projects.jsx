...
// Single-family galleries. The projects below carry the firm's own masters, baked
// by tools/bake-projects.py from the SINGLE FAMILY archive; the rest are still
// wix media ids. Either kind resolves through wix(). Cover is gallery[0].
const GAL = {
...
const CATEGORIES = [
  {
    ...
    items: [
      ...
      { id: "villa-casbah", name: "Villa Casbah", loc: "Beverly Grove, Los Angeles", year: "2021", gallery: GAL["villa-casbah"],
      ...
      { id: "casa-mani", name: "Casa Mani", loc: "Beverly Hills", year: "2017", gallery: GAL["casa-mani"],
      ...
      { id: "villa-marbella", name: "Villa Marbella", loc: "Beverly Grove, Los Angeles", year: "2022", gallery: GAL["villa-marbella"],
      ...
      { id: "quiet-storm", name: "Quiet Storm", loc: "Outpost Estates, Beverly Hills", year: "2018", gallery: GAL["quiet-storm"], cover: "5c383b_37553457927949b9b353ffd1e3210bb7~mv2_d_2560_1440_s_2.jpg", rendering: true,
      ...
      { id: "house-g", name: "House G", loc: "Melrose, Los Angeles", year: "2016", gallery: GAL["house-g"], cover: "5c383b_d8b5e33dc63c4cd9af9019f54523ea3f~mv2_d_5730_5687_s_4_2.jpg",
