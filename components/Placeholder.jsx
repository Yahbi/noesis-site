...
function wix(id, opts = {}) {
  ...
  // Portfolio photography baked from the firm's own masters by tools/bake-projects.py.
  // "sf-casbah-01" carries the same three rungs as the ENHANCED map below, so the
  // card grid stops downloading a 2000px master into a 1300px slot.
